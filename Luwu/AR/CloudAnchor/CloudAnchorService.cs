...
namespace Luwu.CloudAnchors
{
    ...
    public class CloudAnchorService : MonoBehaviour
    {
        ...
        /// <summary>
        /// Occurs when on anchor create.
        /// </summary>
        private event System.Action<Transform> onAnchorCreated;

        private event System.Action<CloudServiceResponse> onAnchorUploaded;
        ...
        public void Update()
        {
            ...
            if (m_LastPlacedAnchor != null)
            {
                ...
                {
                    onAnchorCreated(m_LastPlacedAnchor.transform);
                }
        ...
        /// already in it.
        /// </summary>
        public void HostingAnchor(int room,System.Action<Transform> anchorCreatedHandler)
        {
            ...
            onAnchorCreated = anchorCreatedHandler;

            m_CurrentMode = ApplicationMode.Hosting;
            m_CurrentRoom = room;
        }

        public void CancelHostingAnchor()
        {
            m_CurrentMode = ApplicationMode.Ready;
            _ResetStatus();
        }

        public void CancelResolveAnchor()
        {
            m_CurrentMode = ApplicationMode.Ready;
            _ResetStatus();
        }
        ...
        private void _HostLastPlacedAnchor()
        {
...
#endif
            Luwu.Logger.Info("Attempting Host Anchor...");
            XPSession.CreateCloudAnchor(anchor).ThenAction(result =>
            {
                ...
                else
                {
                    ...
                    Luwu.Logger.Info("Cloud anchor was created and saved.");
                }
                if (onAnchorUploaded != null)
                {
                    onAnchorUploaded(result.Response);
                }
            });
#endif
        }
